...
| 08 | [public-api-surface.md](08-public-api-surface.md) | The crate surface and its audiences: operator-vs-combinator vocabulary, module inventory, the settled user/sibling/internal boundary (`malstrom-core-internal`, kernel-owned `OperatorBuilder`/`Forward`, public comm/distributed types), and the remaining gaps |
