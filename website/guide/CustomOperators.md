...
<<< @../../malstrom-examples/examples/custom_stateless_operator.rs#custom_impl
...
<<< @../../malstrom-examples/examples/custom_stateless_operator.rs#usage
...
::: details Full code
<<< @../../malstrom-examples/examples/file_sink_stateless.rs
:::
...
<<< @../../malstrom-examples/examples/custom_stateful_operator.rs#custom_impl
...
<<< @../../malstrom-examples/examples/custom_stateful_operator.rs#on_epoch
...
<<< @../../malstrom-examples/examples/custom_stateful_operator.rs#usage
...
::: details Full code
<<< @../../malstrom-examples/examples/custom_stateful_operator.rs
:::
